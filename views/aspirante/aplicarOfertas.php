...
?>
<?php 
$mysqli = new mysqli('localhost', 'root', '', 'silto1');
?>
<!doctype html>
...
<?php include('../../includes/menulateralAspirante.php') ?>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
            <div class="text-center custom-login mt-20px">
                <h3 class="registro-usuario">APLICAR OFERTA</h3>
                <p>Todos los campos son obligatorios</p>
            </div>
            <div class="hpanel">
                <div class="panel-body">
                    <form action="../../controller/aspirante/insertarOfertaAplicada.php" id="loginForm" method="post" enctype="multipart/form-data">
                        <div class="row">
                        
                            <div class="form-group col-lg-6">
                            
                                <label>Oferta</label>
                                <select class="form-control" name="nombre" style="width:100%" required>
                                    <option selected value="">Seleccione...</option>
                                    <?php
                                    $query = $mysqli->query("SELECT * FROM oferta");
                                    while($ofertas = mysqli_fetch_array($query)){
                                        echo '<option value="'.$ofertas['id_oferta'].'">'.$ofertas['nombre'].'</option>';
                                    }
                                    ?>
                                    
                                </select>
                                <small id="ofertaHelp" class="form-text text-muted">OFERTA</small>
                            </div>
                            <!-- <div class="form-group col-md-6">
                                    <label for="nombre">Oferta</label>
                                    <input type="text" class="form-control" name="nombre" id="nombre" required>
                                    <small id="nombreHelp" class="form-text text-muted">Diligencie la direccion del Centro</small>
                                </div> -->
                            <div class="form-group col-md-6">
                                    ...
                                    <small id="identificacionHelp" class="form-text text-muted">Diligencie la direccion del Centro</small>
                                </div>
                        </div>
                        
                        <div class="text-center">
                            <button class="btn btn-success loginbtn">APLICAR</button>
